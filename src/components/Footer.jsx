                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="https://facebook.com/vince6910" className="text-gray-700 hover:text-gray-200">
                                <i className="fab fa-facebook-f">Facebook</i>
                            </a>
                            <a href="https://twitter.com" className="text-gray-700 hover:text-gray-200">
                                <i className="fab fa-twitter">Twitter</i>
                            </a>
                            <a href="https://instagram.com" className="text-gray-700 hover:text-gray-200">
                                <i className="fab fa-instagram">Instagram</i>
                            </a>
                            <a href="https://linkedin.com/in/vincepradas" className="text-gray-700 hover:text-gray-200">
