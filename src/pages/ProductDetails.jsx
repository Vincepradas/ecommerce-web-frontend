...
const ProductDetails = () => {
    ...
    return (<div className="product-details container mx-auto px-6 py-12 ">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start md:items-center mb-12">
            ...
            <div className="w-full md:w-1/2">
                ...
                </Swiper>) : (<p>No media available for this product.</p>)}
                <style>
                    {`
    /* Change the color of the Swiper navigation arrows */
    .swiper-button-next,    
    .swiper-button-prev {
    ...
    .swiper-button-prev:hover {
        color: gray; /* Set your desired hover color */
    }
